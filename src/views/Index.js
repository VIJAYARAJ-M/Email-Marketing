...
import Call from "./examples/Call Campaign Report";
...
import Call1 from "./examples/Call Tracking Report";
import Model4 from "./examples/Model4";
    ...
    <>
      ...
      <Container className="pb-8 pt-5 pt-md-8" fluid style={{backgroundColor:"#19335A"}}>
        ...
        <Tabs defaultActiveKey="model1" className="mt--4">
          ...
          <Tab eventKey="model4" title="Email Campaign 4">
          <Model4/>
          </Tab>
          <Tab eventKey="call" title="Call Campaign 1">
           <Call/>
          </Tab>
          <Tab eventKey="call1" title="Call Campaign 2">
           <Call1/>
          </Tab>
