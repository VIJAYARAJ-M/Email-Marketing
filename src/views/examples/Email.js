           ...
           <Row>
            <Col lg={4}>
                  ...
                  <Row className="mt-2">
                    ...
                    <Col >
                    <Row>
                      <h4 className="text-white">Email Recepients</h4>
                    </Row>
                    <Row className="mt-2">
                  ...
                  <Card className="p-1 mt-1" style={{backgroundColor:"#002151"}}>
                  <Row className="mt-2">
                  ...
                  <Row className="mt-2">
                    ...
                    <Col>
                    <Row>
                      <h4 className="text-white">Email Unopen</h4>
                    </Row>
                    <Row className="mt-2">
                  ...
                  <Row className="mt-2">
                    ...
                    <Col>
                    <Row>
                      <h4 className="text-white">Email Click</h4>
                    </Row>
                    <Row className="mt-2">
                  ...
                  <Row className="mt-2">
                    ...
                    <Col>
                    <Row>
                      <h4 className="text-white">Email Unclick</h4>
                    </Row>
                    <Row className="mt-2">
                      <h1 className="text-white">50</h1>
                    </Row>
            ...
            <Col lg={8}>
              <Row>
                <Col lg={6}>
                  <Card className="p-3" style={{backgroundColor:"#002151"}}>
                    <ReactApexChart options={optionss} series={seriess} type="line" height={207} />
              ...
              <Row className="mt-2">
                <Col lg={6}>
                  <Card className="p-3" style={{backgroundColor:"#002151"}}>
                  <ReactApexChart options={option22} series={series22} type="bar" height={207} />
              ...
              <Row className="mt-2">
                ...
                <Col>
                  <Card className="p-2" style={{backgroundColor:"#002151"}}>
                  <ReactApexChart options={options111} series={series111} type="line" height={200} />
              ...
              <Row className="mt-2">
                <Col>
                  <Card className="" style={{boxShadow:"",backgroundColor:"#002151",height:"280px",
